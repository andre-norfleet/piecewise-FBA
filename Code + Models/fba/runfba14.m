%system('cd /storage/scratch1/5/dnorfleet7/my_simdre2/gurobi1103/linux64/matlab');
%system('matlab gurobi_setup.m');
%system('cd '/storage/scratch1/5/dnorfleet7/my_simdre2/piecewise-FBA/Code + Models/fba'');

addpath(genpath('/storage/scratch1/5/dnorfleet7/my_simdre2/gurobi1103/linux64/matlab'))
% input folder name
input_folder = "D0_ATPall_nofluxmod_mTeSRctrl"
...
if gene_knockdown_screen
    ...
    [catalase_version, module_5fu, module_cis, module_cpa, module_dox, module_glc] = parse_modules(input_file{1}); %added module_glc 07/11/22 by Riya
    ...
    for a = 1:length(input_files)
        ...
        % load media
        [model,concentration_mets,concentration_values,exchange_rxn] = load_media(model,media_choice,media_constraint_metabolite,media_constraint_uptake,concentration_mets,concentration_values,module_5fu,module_cis,module_cpa,module_dox, module_glc); %added module_glc on 07/11/22 by Riya
...
elseif objective_function_screen
    ...
    for a = 1:length(input_files)
        ...
        % load media
        [model,concentration_mets,concentration_values,exchange_rxn] = load_media(model,media_choice,media_constraint_metabolite,media_constraint_uptake,concentration_mets,concentration_values,module_5fu,module_cis,module_cpa,module_dox, module_glc); %added module_glc 07/11/22 by Riya
...
% if not either
    ...
    for a = 1:length(input_files)
        ...
        % parse input file - modules
        [catalase_version, module_5fu, module_cis, module_cpa, module_dox] = parse_modules(input_file{1}); %added module_glc 07/11/22 by Riya
        ...
        % load media
        [model,concentration_mets,concentration_values,exchange_rxn] = load_media(model,media_choice,media_constraint_metabolite,media_constraint_uptake,concentration_mets,concentration_values,module_5fu,module_cis,module_cpa,module_dox);%added module_glc 07/11/22 by Riya
        ...
        % run FBA for each sample
        run_fba(input_folder,output_folder,input_file{1},model,type_of_analysis,samples_all,samples_all_source,samples_all_source_protein,vmax_forward,vmax_reverse,objective_function_direction,objective_function_weight,objective_function_reaction,exchange_rxn,deltag_lower,deltag_upper,constraints_fraction_count,constraints_fraction_type,constraints_fraction_reaction,constraints_fraction_value,constraints_fraction_id,constraints_maxmulti_fraction,constraints_maxmulti_count,pfba_fraction,fva_all_fraction,fva_select_fraction,fva_select_groups,fva_select_reactions,sampler_fraction,sampler_samples,sampler_steps,media_sensitivity_critical_fraction,media_sensitivity_critical_metabolite1,media_sensitivity_spectrum_fraction,media_sensitivity_spectrum_metabolite1,media_sensitivity_spectrum_metabolite2,media_sensitivity_spectrum_points,parallel_cores,knockdown_genes,knockdown_fractions,catalase_version,module_5fu,module_cis,module_cpa,module_dox);%added module_glc 07/11/22 by Riya
        %run_fba33(input_folder,output_folder,input_file{1},model,type_of_analysis,samples_all,samples_all_source,samples_all_source_protein,vmax_forward,vmax_reverse,objective_function_direction,objective_function_weight,objective_function_reaction,exchange_rxn,deltag_lower,deltag_upper,constraints_fraction_count,constraints_fraction_type,constraints_fraction_reaction,constraints_fraction_value,constraints_fraction_id,constraints_maxmulti_fraction,constraints_maxmulti_count,pfba_fraction,fva_all_fraction,fva_select_fraction,fva_select_groups,fva_select_reactions,sampler_fraction,sampler_samples,sampler_steps,media_sensitivity_critical_fraction,media_sensitivity_critical_metabolite1,media_sensitivity_spectrum_fraction,media_sensitivity_spectrum_metabolite1,media_sensitivity_spectrum_metabolite2,media_sensitivity_spectrum_points,parallel_cores,knockdown_genes,knockdown_fractions,catalase_version,module_5fu,module_cis,module_cpa,module_dox);
        %run_fba333(input_folder,output_folder,input_file{1},model,type_of_analysis,samples_all,samples_all_source,samples_all_source_protein,vmax_forward,vmax_reverse,objective_function_direction,objective_function_weight,objective_function_reaction,exchange_rxn,deltag_lower,deltag_upper,constraints_fraction_count,constraints_fraction_type,constraints_fraction_reaction,constraints_fraction_value,constraints_fraction_id,constraints_maxmulti_fraction,constraints_maxmulti_count,pfba_fraction,fva_all_fraction,fva_select_fraction,fva_select_groups,fva_select_reactions,sampler_fraction,sampler_samples,sampler_steps,media_sensitivity_critical_fraction,media_sensitivity_critical_metabolite1,media_sensitivity_spectrum_fraction,media_sensitivity_spectrum_metabolite1,media_sensitivity_spectrum_metabolite2,media_sensitivity_spectrum_points,parallel_cores,knockdown_genes,knockdown_fractions,catalase_version,module_5fu,module_cis,module_cpa,module_dox);
